...
# =========================================================
# CATÉGORIES / PRODUITS / TABLES / UTILISATEURS
# =========================================================
...
def categorie_nouvelle():
    ...
    c = Category(nom=nom, emoji=emoji, restaurant_id=current_user.restaurant_id)
...
def utilisateur_modifier(uid):
    ...
    log_action("USER_UPDATE", cible=f"user#{u.id}",
               details=f"{u.username} | rôle={u.role} | actif={u.actif} | mdp changé={change_mdp}")
